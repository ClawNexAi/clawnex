...
| 1.8 | 2026-04-22 | ClawNex Engineering | v0.6.2-alpha hardening pass: deploy.sh now binds dashboard to 127.0.0.1 only; Caddy (port 443) or Tailscale is the ingress path. No unconditional `ufw allow 5001/tcp`. umask 077 + chmod 600 on sentinel.db*. Release tarball renamed to clawnex-v0.6.2-alpha.tar.gz. See `docs/security-audit-2026-04-22.md` and CHANGELOG §[0.6.2-alpha]. |
