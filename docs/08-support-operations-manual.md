...
| 1.5 | 2026-04-22 | ClawNex Engineering | v0.6.2-alpha hardening pass: LiteLLM supervision, secret handling, audit stdout mirroring, and Trust Audit caching improved. See CHANGELOG §[0.6.2-alpha]. |
