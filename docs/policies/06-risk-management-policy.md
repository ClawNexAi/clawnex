...
| 1.3 | 2026-05-14 | Internal reviewer | Security validation evidence cross-reference added to the public evidence checklist. Public risk posture now summarizes themes instead of publishing internal risk-register detail. |
